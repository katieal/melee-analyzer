...
def get_flex_match_single():
    return html.Div(
        ...
        className='flex-fill d-flex align-items-center border border-primary border-2'
    )
...
def sub_box():
    return html.Div(
        [
            html.Div(className='flex-fill border border-secondary border-2'),
            html.Div(className='flex-fill border border-secondary border-2'),
        ],
        className='flex-fill'
    )
...
def add_boxes(num):
    content = [
        #html.Div(className='flex-grow-1 border border-primary border-2'),
        #html.Div(className='flex-fill border border-primary border-2'),
        #html.Div(className='flex-fill border border-primary border-2'),
        html.Div(className='flex-fill border border-primary border-2'),
        html.Div(className='flex-fill border border-primary border-2'),
        html.Div(
            className='d-flex align-items-center border border-primary border-1',
            style={
            'height': '50%',
...
# split dividers into 4 sections - add split for top half and bot half
# add 1 box/section per match in prev column
...
bracket_grid = html.Div(
    [
        ...
        dbc.Col(add_boxes(4), width=match_width),
    ],
